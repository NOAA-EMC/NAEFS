...
! Method 1: when product difinition template 4.1 change to 4.2
...
! Method 2: when product difinition template 4.11 change to 4.12
...
! Method 3: when product difinition template 4.1 change to 4.5
...
! Method 4: when product difinition template 4.2 change to 4.5
...
! Method 5: when product difinition template 4.1 chenge to 4.15
...
! Method 6: when product difinition template 4.11 chenge to 4.15
...
! Method 7: when product difinition template 4.2 chenge to 4.15
...
! Method 8: when product difinition template 4.12 chenge to 4.15
