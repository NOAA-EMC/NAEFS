...
character*150 cfipg(nmemd)
character*100 cfopg1,cfopg2

real    gmin,gmax
integer nbit

namelist /namens/nfiles,cfipg,iskip,cfopg1,cfopg2
...
if(iret.ne.0) print *,'there is no maxgrd information'; goto 1020
...
do
  ...
  call getgb2(icfipg(1),0,kskp,kdisc,kids,kpdtn,kpdt,kgdtn,kgdt,unpack,kskp,gfldo,iret)
