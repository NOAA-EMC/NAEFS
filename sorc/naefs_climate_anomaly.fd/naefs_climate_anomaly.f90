!
!  Main program    naefs_climate_anomaly
...
!          Bo Cui                mod: anomaly fcst for average         2017-09-01
!
! This is main program to generate climate anomaly forecasts (percentage)              
!
!   subroutine                                                    
...
!     goto 150
  ...
  ! to calculate anomaly forecast for average
