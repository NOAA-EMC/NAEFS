...
102 format(i4,i5,4i4,i8,i6,3i3,2i4,2i4,i8,3f13.2)

200 format(' REC PDTN PD1 PD2 PD3 PD10   PD12  YEAR MN DY HR FHR ',  &
           'E16 E17    LEN         MAX           MIN        EXAMPLE')
202 format(i4,i5,4i4,i8,i6,3i3,3i4,i8,3f13.2)

300 format(' REC PDTN PD1 PD2 PD3 PD10   PD12  YEAR MN DY HR FHR ',  &
           '           LEN         MAX           MIN        EXAMPLE')
302 format(i4,i5,4i4,i8,i6,3i3,i4,8x,i8,3f13.2)
