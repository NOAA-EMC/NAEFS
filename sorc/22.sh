...
#for dir in gefs_climate_anomaly.fd; do
#for dir in naefs_climate_anv.fd; do
#for dir in naefs_climate_anomaly.fd; do
#for dir in naefs_probability.fd; do
for dir in cmcens_post_acc.fd; do
#for dir in cmcens_post_pqpf_24h.fd; do
#for dir in cmcens_bias.fd; do
 cd $dir
 make clean
 make -f makefile
#mv gefs_climate_anomaly ../../exec/
#mv naefs_climate_anv ../../exec/
#mv naefs_bc_probability   ../../exec/
mv cmcens_post_acc     ../../exec/
#mv cmcens_post_pqpf_24h  ../../exec/
#mv cmcens_bias           ../../exec/
 cd ..
done
