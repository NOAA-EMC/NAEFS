...
echo " us para recode  8  8  8  9  8  9  8  9  8  9 " 
echo " us prod recode  6  6  6  7  6  7  6  7  6  7 " 
echo " prod 1536 records, para 3258 records "
echo " "
...
do
    ...
    file=$fdir/$px$prod.t${CYC}z.ndgd_conusf$hr
    line=`wgrib -PDS10 $file | grep " $IDS " | wc -l`
    #line=`wgrib -PDS10 $file | wc -l`
    tline=`expr $tline + $line`
    echo "$px$prod.t${CYC}z.ndgd_conusf$hr has records of $line"
    done
    echo " "
